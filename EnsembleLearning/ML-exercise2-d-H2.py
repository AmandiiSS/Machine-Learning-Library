...
FeatureSetSize = [2,4,6]

for featsize in FeatureSetSize:
    training_errors = []
    test_errors = []
    Trees = []
    for i in range(500):
        ...
        Trees.append(One_random_decisiontree(S,Attributes,Label,gain,depth,featsize)[0])
        ...
        with open(CSVfile, 'r') as f:
            for line in f:
                ...
                predicted_label = randomforest.prediction_RandomForest(Trees,test)
