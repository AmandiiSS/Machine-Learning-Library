...
def add_example_to_S(example_list,median_age,median_fnlwgt,median_educationnum,median_capitalgain,median_capitalloss,median_hoursperweek,common_workclass,common_education,common_maritalstatus,common_occupation,common_relationship,common_race,common_sex,common_nativecountry):
    #age
    if example_list[0] != "?":
        if float(example_list[0]) > median_age:
            age_value = "bigger" 
        else:
            age_value = "lesseq"
    else:
    ...
    #fnlwgt
    if example_list[2] != "?":
        if float(example_list[2]) > median_fnlwgt:
            fnlwgt_value = "bigger" 
        else:
            fnlwgt_value = "lesseq"
    else:
    ...
    #education-num
    if example_list[4] != "?":
        if float(example_list[4]) > median_educationnum:
            educationnum_value = "bigger" 
        else:
            educationnum_value = "lesseq"
    else:
        educationnum_value = "lesseq"
    #marital-status
    if example_list[5] == "?":
    ...
    #capital-gain
    if example_list[10] != "?":
        if float(example_list[10]) > median_capitalgain:
            capitalgain_value = "bigger" 
        else:
            capitalgain_value = "lesseq"
    else:
        capitalgain_value = "lesseq"
    #capital-loss
    if example_list[11] != "?":
        if float(example_list[11]) > median_capitalloss:
            capitalloss_value = "bigger" 
        else:
            capitalloss_value = "lesseq"
    else:
        capitalloss_value = "lesseq"
    #hours-per-week
    if example_list[12] != "?":
        if float(example_list[12]) > median_hoursperweek:
            hoursperweek_value = "bigger" 
        else:
            hoursperweek_value = "lesseq"
    else:
        hoursperweek_value = "lesseq"
    #native-country
    if example_list[13] == "?":
...
Attributes = {
    ...
    #continous
    "fnlwgt":["bigger","lesseq"],
    "education":["Bachelors","Some-college","11th","HS-grad","Prof-school","Assoc-acdm","Assoc-voc","9th","7th-8th","12th","Masters","1st-4th","10th","Doctorate","5th-6th","Preschool"],
    #continous
    "education-num":["bigger","lesseq"],
    ...
    "sex":["Female","Male"],
    #continous
    "capital-gain":["bigger","lesseq"],
    #continous
    "capital-loss":["bigger","lesseq"],
    #continous
    "hours-per-week":["bigger","lesseq"],
...
with open(CSVfile, 'r') as f:
    for line in f:
        ...
        if example_list[4] != "?":
            educationnum.append(float(example_list[4]))
        if example_list[5] != "?":
...
median_fnlwgt = statistics.median(fnlwgt)
median_educationnum = statistics.median(educationnum)
median_capitalgain = statistics.median(capitalgain)
median_capitalloss = statistics.median(capitalloss)
median_hoursperweek = statistics.median(hoursperweek)
...
with open(CSVfile, 'r') as f:
    for line in f:
        example_list = line.strip().split(',')
        S.append(add_example_to_S(example_list,median_age,median_fnlwgt,median_educationnum,median_capitalgain,median_capitalloss,median_hoursperweek,common_workclass,common_education,common_maritalstatus,common_occupation,common_relationship,common_race,common_sex,common_nativecountry))
...
with open(CSVfile, 'r') as f:
    for line in f:
        ...
        test = add_example_to_S(example_to_test,median_age,median_fnlwgt,median_educationnum,median_capitalgain,median_capitalloss,median_hoursperweek,common_workclass,common_education,common_maritalstatus,common_occupation,common_relationship,common_race,common_sex,common_nativecountry)[0]
        predicted_label = decisiontree.prediction(Tree,test)
        data.append({"ID":identifier,"Prediction":predicted_label})
        #print(data)
        
with open('predictions/submission_Amanda_SS_decisiontree_2_gini_2intervals.csv', 'w', newline='') as file:
