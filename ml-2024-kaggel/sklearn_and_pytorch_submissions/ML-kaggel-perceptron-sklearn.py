...
#Test 1
# pcp = Perceptron(max_iter=1000, tol=1e-3)
#Test2
pcp = Perceptron(max_iter=1000, tol=1e-3, random_state=42)
...
submission_data.to_csv('predictions/submission_Amanda_SS_perceptron_test2.csv', index=False)
